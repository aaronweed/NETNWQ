...
VarList<-c("Water Temperature" , "Specific conductance","DO_mg.L","DO (%)","pH","BP_mmHg","Discharge","TotalArea","TotalVel","DEPTH", "FPH","eqPH", "ACOLOR","TCOLOR",
...
shinyUI(navbarPage(title=HTML("<div> <a href='https://science.nature.nps.gov/im/units/netn/'> <img src='ah_small_black.gif',
          alt='WQ Visualizer'> </a> NETN Lakes, Ponds, and Streams Visualizer</div>"),position = "static-top", inverse=TRUE, collapsible = FALSE, fluid=TRUE, 
           windowTitle = "NETN Lakes, Ponds, and Streams Visualizer Visualizer", id="MainNavBar",
...
fluidPage(
  sidebarPanel(
    h4("Plot summary stats from each sampled site."),
    br(),
