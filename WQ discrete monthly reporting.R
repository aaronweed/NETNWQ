...
###########################################################################################################
# interactive plot
SeriesBySiteInt(data= WQdata, site="ACSTNL",parm= "pH")

# static plot and you can add linear trend; scale = "nomr" or "log"
scattertimesite(data= WQdata, site="ACKEBO",parm= "DOC_mgL", trend ="N", scale ="log")

scattertimepark(data= WQdata,type = "stream",park="MORR",parm= "NO2+NO3_mg/L", trend ="N", scale ="norm", overlay ="N")
...
BivarPark(data=  WQdata, type= "stream", park = "MORR", x= "Temp_C", y = "DO_mg.L" , reg = "N")
...
TrendPerMonthsite(data= discrete, month = "10", site="ACABIN",parm= "Temp_C", trend = "Y")
